...
var _students = __webpack_require__(19);
...
{
  var _a = 'Hello from another scope!';
  console.log(_a);
}
...
{
  var wizard = { magical: true, power: 10 };
...
// [ Filter Method ]
{
  var winner = function winner(result) {
    return result >= 100;
  };
  var _points = [100, 190, 89, 11, 677, 33];
  console.log(_points.filter(winner));
}

// [Modules]

console.log(_students.students, _students.total);
...
var Frodo = new Hobbit("Frodo", 5.5);
Frodo.greet();
...
var students = exports.students = ['John', 'Camila', 'Mary'];
var total = exports.total = 3;
